...
public class DashboardFunderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferencesHelper = new PreferencesHelper(DashboardFunderActivity.this);
        ...
        recyclerView.addOnScrollListener(new EndlessRecyclerViewScrollListener(linearLayoutManager,swipeRefreshLayout) {
            ...
            public void onLoadMore(int page, int totalItemsCount) {
                if(totalItemsCount<fundersData.getTotalCount()){
    ...
    private void loadFunders(String projectId, final int offset){
     ...
     //   Call<FundersData> call = restInterface.ProjectFunders(token,projectId,String.valueOf(offset),"dashboard");
  /*      call.enqueue(new Callback<FundersData>() {
            @Override
            public void onResponse(Call<FundersData> call, Response<FundersData> response) {
                try {
                    Gson gson = new Gson();
                 //   fundersData = gson.fromJson(result.getJSONObject(Constants.DATA).toString(), FundersData.class);
                    ...
                    if(offset==0){
                        ...
                        funderListAdapterMain = new FunderListAdapterMain(fundersList,DashboardFunderActivity.this);
            ...
            @Override
            public void onFailure(Call<FundersData> call, Throwable t) {
                    t.printStackTrace();
            }
        });*/
