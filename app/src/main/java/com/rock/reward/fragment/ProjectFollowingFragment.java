...
import com.rock.reward.adapter.FollowingProjectAdapter;
...
public class ProjectFollowingFragment extends Fragment {
    ...
    public void getProjects(int offset){
      ...
      //  Call<FollowingProjectsData> call = restInterface.UserFollowingProjects(token,String.valueOf(offset));
   /*     call.enqueue(new Callback<FollowingProjectsData>() {
            @Override
            public void onResponse(Call<FollowingProjectsData> call, Response<FollowingProjectsData> response) {
                Gson gson = new Gson();
                try {
...
//                        adapter.clear();
            ...
            @Override
            public void onFailure(Call<FollowingProjectsData> call, Throwable t) {
                         t.printStackTrace();
            }
        });*/
