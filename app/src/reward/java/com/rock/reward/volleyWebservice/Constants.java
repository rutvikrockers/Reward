...
//    public static final String CONTENT_TYPE_VALUE = "multipart/form-data";
    ...
    public static final String PROFILE_SLUG = "profile_slug";
    ...
    public static final String LINKEDIN_URL = "linkedln_url";
    public static final String MYSPACE_URL = "myspace_url";
    public static final String WEBSITE_URL = "user_website";
    public static final String BANDCAMP_URL = "bandcamp_url";
    ...
    public static final String USER_IMAGE_PASS = "user_image";
...
//        public static final String API_DOMAIN = "http://reward.crowdfundingscript.com/";
         ...
         * The Constant project detail
         */
        public static final String MY_FUNDING = API_DOMAIN + "api/user/raisedfund";
         ...
         * The Constant project detail
         */
        public static final String USER_FOLLOWERS = API_DOMAIN + "api/user/myfollowings";

        /**
         * The Constant project detail
         */
        public static final String UPDATE_ACCOUNT = API_DOMAIN + "api/user/update_account";

        /**
         * The Constant project detail
         */
        public static final String UPDATE_USER_IMAGE = API_DOMAIN + "api/user/updateprofileimage";

        /**
         * The Constant project detail
         */
        public static final String COMMENT_ACTION = API_DOMAIN + "api/projectobj/addUpdateComment";
