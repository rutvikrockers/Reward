...
public class DashboardUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferencesHelper = new PreferencesHelper(DashboardUpdateActivity.this);
    ...
    private void loadUpdates(String ProjectId){
     ...
     //   Call<UpdatesData> call = restInterface.ProjectUpdates(token,ProjectId,"dashboard");
     /*   call.enqueue(new Callback<UpdatesData>() {
            @Override
            public void onResponse(Call<UpdatesData> call, Response<UpdatesData> response) {
                try {
                    Gson gson = new Gson();
                    updatesData = gson.fromJson(response.body().toString(), UpdatesData.class);
