...
import com.rock.reward.adapter.ActivityListAdapter;
...
public class MyActivityFragment extends Fragment {
   ...
   //     Call<MyActivitiesData> call = restInterface.UserActivities(token,String.valueOf(offset));
    /*    call.enqueue(new Callback<MyActivitiesData>() {
            @Override
            public void onResponse(Call<MyActivitiesData> call, Response<MyActivitiesData> response) {
                Gson gson = new Gson();
                try {
...
//                        adapter.clear();
            ...
            @Override
            public void onFailure(Call<MyActivitiesData> call, Throwable t) {
                     t.printStackTrace();
            }
        });*/
